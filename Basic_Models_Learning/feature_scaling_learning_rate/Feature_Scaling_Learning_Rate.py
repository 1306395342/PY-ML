...
#set alpha to 9.9e-7 /big
_, _, hist = run_gradient_descent(X_train, y_train, 10, alpha = 9.9e-7)

plot_cost_i_w(X_train, y_train, hist)

#set alpha to 9e-7 /common
_,_,hist = run_gradient_descent(X_train, y_train, 10, alpha = 9e-7)

plot_cost_i_w(X_train, y_train, hist)

#set alpha to 1e-7 // small
...
# First, normalize out example. because w is used norm to caculate so need to use xnorm to cal 
